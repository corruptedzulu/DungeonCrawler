...
public class Camera3PController
{
	 ...
	 { 
		 if(type == "K")//KEYBOARD
		 {
			 ...
			 im.associateAction(cn, net.java.games.input.Component.Identifier.Key.LEFT, orbitActionCounterclockwise, IInputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
			 IAction orbitActionClockwise = new OrbitAroundAction(-1.0);
			 im.associateAction(cn, net.java.games.input.Component.Identifier.Key.RIGHT, orbitActionClockwise, IInputManager.INPUT_ACTION_TYPE.REPEAT_WHILE_DOWN);
		 
			 IAction zoomInAction = new ZoomCameraAction(1.0);
			 im.associateAction(cn, net.java.games.input.Component.Identifier.Key.Z, zoomInAction, IInputManager.INPUT_ACTION_TYPE.ON_PRESS_ONLY);

			 IAction zoomOutAction = new ZoomCameraAction(-1.0);
			 im.associateAction(cn, net.java.games.input.Component.Identifier.Key.X, zoomOutAction, IInputManager.INPUT_ACTION_TYPE.ON_PRESS_ONLY);
		 ...
		 if(type == "G")//GAMEPAD
		 {
			 ...
			 IAction orbitActionCounterclockwise = new OrbitAroundAction(1.0);
			 im.associateAction(cn, net.java.games.input.Component.Identifier.Button._3, orbitActionCounterclockwise, IInputManager.INPUT_ACTION_TYPE.ON_PRESS_ONLY);
			 IAction orbitActionClockwise = new OrbitAroundAction(-1.0);
			 im.associateAction(cn, net.java.games.input.Component.Identifier.Button._2, orbitActionClockwise, IInputManager.INPUT_ACTION_TYPE.ON_PRESS_ONLY);
		 
			 IAction zoomInAction = new ZoomCameraAction(1.0);
			 im.associateAction(cn, net.java.games.input.Component.Identifier.Button._5, zoomInAction, IInputManager.INPUT_ACTION_TYPE.ON_PRESS_ONLY);
